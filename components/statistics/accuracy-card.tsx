    ...
    <Card className="md:col-span-1 relative overflow-hidden group hover:shadow-lg transition-all duration-300 dark:bg-neutral-900/50 h-full">
      <div className="flex flex-col h-full">
        <CardHeader className="flex flex-row items-center justify-between pb-4 sm:pb-6 space-y-0">
          ...
          <Target className="w-6 h-6 sm:w-7 sm:h-7 text-primary animate-pulse" />
        </CardHeader>
        <CardContent className="flex-1 flex flex-col justify-center space-y-4 sm:space-y-6 pt-2 sm:pt-4 pb-6 sm:pb-8">
          <div className="flex items-center justify-center">
            <span className={`text-4xl sm:text-6xl font-bold ${getAccuracyColor(roundedAccuracy)} transition-colors duration-300`}>
              {roundedAccuracy}%
            </span>
          </div>
          <div className="space-y-4 sm:space-y-6">
            <Progress 
              ...
              className="w-full h-2 sm:h-3 rounded-lg transition-all duration-500"
              style={{
                background: 'linear-gradient(to right, rgb(239 68 68 / 0.2), rgb(234 179 8 / 0.2), rgb(34 197 94 / 0.2))'
              }}
            />
            <p className={`text-sm sm:text-base text-center transition-colors duration-300 leading-relaxed`}>

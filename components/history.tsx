        ...
        >
          <CardContent className="p-0">
            <Link href={`/statistics/${game.id}`} className="block">
              <div className="flex items-center p-6 bg-gradient-to-r from-primary/10 via-primary/5 to-transparent">
                {game.gameType === "mcq" ? (
                  <CopyCheck className="w-8 h-8 mr-4 text-primary" />
                ) : (
                  <Edit2 className="w-8 h-8 mr-4 text-primary" />
                )}
                <div>
